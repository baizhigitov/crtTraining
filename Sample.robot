...
Add to Cart - Copado Exercise
     [Documentation]    Add Product to Cart
     GoTo               https://qentinelqi.github.io/shop/
     VerifyText         The animal friendly clothing
...
Test
    [Documentation]     Testing how this behaves
    GoTo                https://www.mooc.fi/en/
    ClickText           COURSES
    VerifyText          Programming MOOC 2026, Introduction to Programming
    ClickText           Programming MOOC 2026, Introduction to Programming
    VerifyText          Timetable

test flow mode
    [Documentation]   Test Case created using the QEditor
    GoTo              https://www.google.com/
    ClickText         Reject all
    TypeText          Search            salesforce\n
    GoTo              https://www.google.com/search?q\=success+copado&oq\=success+copado&gs_lcrp\=EgZjaHJvbWUyBggAEEUYOdIBCDI4MzVqMGo0qAIAsAIB&sourceid\=chrome&ie\=UTF-8
